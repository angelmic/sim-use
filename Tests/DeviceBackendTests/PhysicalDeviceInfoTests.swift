...
final class PhysicalDeviceInfoTests: XCTestCase {
    ...
    func testInitFromDeviceRejectsSimulatorAndAndroid() {
        let sim = Device(udid: "u", name: "n", platform: .ios, kind: .simulator, state: "Booted", runtime: "iOS 18.4")
        let android = Device(udid: "emulator-5554", name: "n", platform: .android, kind: .simulator, state: "device", runtime: nil)
    ...
    func testInitFromDeviceCarriesFamilyAndTunnelState() throws {
        let tv = Device(udid: "c311", name: "TV", platform: .tvos, kind: .physical, state: "connected", runtime: "tvOS 26.5")
