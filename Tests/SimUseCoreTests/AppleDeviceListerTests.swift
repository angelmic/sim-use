...
struct AppleDeviceListerMergeTests {
    private let devicectlRows = [
        Device(udid: "00008110-001234567890001E", name: "Test iPhone",
               platform: .ios, kind: .physical, state: "connected", runtime: "iOS 18.7.8"),
    ]
    ...
    func promotesReachableOverlap() throws {
        let staleRows = [
            Device(udid: "00008110-001234567890001E", name: "Test iPhone",
                   platform: .ios, kind: .physical, state: "connecting", runtime: "iOS 18.7.8"),
            Device(udid: "OTHER", name: "Offline iPhone",
                   platform: .ios, kind: .physical, state: "unavailable", runtime: "iOS 18.7"),
        ]
